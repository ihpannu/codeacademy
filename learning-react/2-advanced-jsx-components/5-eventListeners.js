...
// Notice that the component class has two methods: .myFunc() and .render(). .myFunc() is 
// being used as an event handler. .myFunc() will be called any time that a user hovers over 
// the rendered <div></div>.
